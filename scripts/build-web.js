...
async function main() {
    ...
    try {
        ...
        console.error('[@adobedjangir/commerce-admin-ims-access] esbuild missing — run `npm install` in the package directory.');
        process.exit(1);
    }
    ...
    console.log('[@adobedjangir/commerce-admin-ims-access] built web/dist/index.js');
}
