...
const PACKAGE_NAME = '@adobedjangir/commerce-admin-ims-access'
const RUNTIME_KEY  = 'ImsAccess'
const INCLUDE_REL  = 'node_modules/@adobedjangir/commerce-admin-ims-access/actions/ext.config.yaml'
const REGISTER_IMPORT = "import registerImsAccess from '@adobedjangir/commerce-admin-ims-access/web'"
const REGISTER_CALL   = 'registerImsAccess()'
